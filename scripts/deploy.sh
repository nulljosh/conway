...
cd "$(dirname "$0")/.."
BUILD=$(mktemp -d)
cp index.html play.html privacy.html life.js devices.css icon.svg icon-192.png icon-512.png icon-512-maskable.png manifest.webmanifest sw.js _headers "$BUILD/"
